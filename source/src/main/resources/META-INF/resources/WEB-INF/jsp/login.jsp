...
<body>
								...
								<li class="dropdown mega-dropdown active"><a class="color1"
									...
									<div class="dropdown-menu ">
										<div class="menu-top">
											...
											<div class="col1 col5">
												<img src="resources/images/me.png" class="img-responsive"
													alt="">
											</div>
											<div class="clearfix"></div>
										</div>
								...
								<li class="dropdown mega-dropdown active"><a class="color2"
									...
									<div class="dropdown-menu mega-dropdown-menu">
										<div class="menu-top">
											...
											<div class="col1 col5">
												<img src="resources/images/me1.png" class="img-responsive"
													alt="">
											</div>
											<div class="clearfix"></div>
										</div>
	...
	<div class="container">
		<div class="login">
			...
			<form:form id="loginForm" action="/user/signin" method="post"
				modelAttribute="userLogin">
				<div class="col-md-6 login-do">
					<div class="login-mail">
						<form:input id="email" path="email" type="text" placeholder="Email" required="" />
						<i class="glyphicon glyphicon-envelope"></i>
					</div>
					<div class="login-mail">
						<form:input id="password" path="password" type="password" placeholder="Password" required="" />
		...
		<div class="footer-bottom">
			<div class="container">
				<ul class="footer-bottom-top">
					<li><a href="#"><img src="resources/images/f1.png"
							class="img-responsive" alt=""></a></li>
					<li><a href="#"><img src="resources/images/f2.png"
							class="img-responsive" alt=""></a></li>
					<li><a href="#"><img src="resources/images/f3.png"
							class="img-responsive" alt=""></a></li>
				</ul>
